#!/bin/bash 
#SBATCH --job-name=HUMAN_combine
#SBATCH -o comb_HUMAN-%j.output
#SBATCH -e combdin_HUMAN-%j.output
...
LIB_OUT="/share/proteomics/Data/lab/service/off_campus/NIST/bat_sparrow_project_2024_2025/Species_specific_folders/HUMAN/DIA-NN/libs/HUMAN_lib_final_2.parquet"
...
--lib \"$LIB_PATH\" --threads 40 --verbose 1 --qvalue 0.01 --matrices --met-excision --cut K*,R* --missed-cleavages 1 --unimod4 --var-mods 1 --fasta \"$FASTA_PATH\" --mass-acc 15 --mass-acc-ms1 15 --rt-profiling --pg-level 1 --out-lib \"$LIB_OUT\" --gen-spec-lib --use-quant --quant-ori-names 
